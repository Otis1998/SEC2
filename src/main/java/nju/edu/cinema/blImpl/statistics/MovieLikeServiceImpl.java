...
import nju.edu.cinema.bl.statistics.MovieLikeService;
import nju.edu.cinema.blImpl.management.schedule.MovieServiceForBl;
import nju.edu.cinema.blImpl.user.AccountServiceForBl;
import nju.edu.cinema.data.statistics.MovieLikeMapper;
import nju.edu.cinema.po.DateLike;
import nju.edu.cinema.vo.DateLikeVO;
...
public class MovieLikeServiceImpl implements MovieLikeService {
    ...
    public ResponseVO likeMovie(int userId, int movieId) {
        if (accountServiceForBl.getAccountById(userId) == null){
